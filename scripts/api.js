...
var GeotabApi = function (getCredentialsCallback, newOptions, customCredentialStore) {
    ...
    var
         ...
         *  @callback {successCallback} callbackSuccess The function that is called if the method call was successful
         *  @callback {failureCallback} [callbackError] The function that is called if the method call failed
         */
         ...
         *  @callback {successCallback} callbackSuccess The function that is called on the successful authentication
         *  @callback {failureCallback} [callbackError] The function that is called when there is an
        ...
        //authenticateWithServer = function (callbackSuccess, callbackError) {
            server = newServer;
         ...
         *  @private
         *  @callback {successCallback} [callbackSuccess] Called when we have successfully authenticated
         */
         ...
         *                                                   ]
         *  @callback {successCallback} callbackSuccess The function that is called if the method calls were all successful
         *  @callback {failureCallback} [callbackError] The function that is called if any method call failed
         */
         ...
         *  @callback {successCallback} callbackSuccess The function that is called if the retrieval of sessionId was successful
